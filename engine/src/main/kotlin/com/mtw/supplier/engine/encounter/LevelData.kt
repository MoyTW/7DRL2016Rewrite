...
class LevelBlueprint(
    ...
    val depthEncounterTable: Map<EncounterChallengeRating, Int>
) {
    /**
...
object LevelData {
    val depthsToBlueprints: Map<Int, LevelBlueprint> = mapOf(
        ...
        8 to LevelBlueprint(levelDepth = 8,
            satellitesPerZone = 10,
            depthEncounterTable = mapOf(EncounterChallengeRating.SIX to 1)),
        9 to LevelBlueprint(levelDepth = 9,
            satellitesPerZone = 30,
            depthEncounterTable = mapOf(EncounterChallengeRating.SEVEN to 1))
    )
}